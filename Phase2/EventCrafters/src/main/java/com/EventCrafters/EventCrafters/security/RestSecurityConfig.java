...
public class RestSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/events/profile/graph").hasRole("ADMIN");



		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/events/user").permitAll();
		...
		http.authorizeRequests().antMatchers(HttpMethod.POST, "/api/auth/logout").permitAll();
		http.authorizeRequests().antMatchers(HttpMethod.POST, "/api/auth/refresh").permitAll();
